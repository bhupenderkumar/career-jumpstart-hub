...
import { createCleanPrintWindow, formatResumeForPrint } from "@/utils/printUtils";
...
const ResumeViewer: React.FC<ResumeViewerProps> = ({
  ...
  const handlePrintResume = () => {
    ...
    try {
      // Format the resume content for printing
      const formattedContent = formatResumeForPrint(resume);
      ...
      toast({
        ...
        description: "Your resume is ready to print with clean formatting!",
      });
    } catch (error) {
      toast({
        title: "Print Error",
